	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>PV 관리</h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">PV 관리</a>
				</div>
			</div>
			<!-- end header -->
				...
				<div class="page_searchBox">
					<div class="searchArea">
						...
						<div class="search-box">
							<input type="text" class="width-600 ml5" placeholder="검색어를 입력하세요" id="keyword" onkeypress="if(event.keyCode==13)gridList();"/>
...
<script type="text/javascript">
	...
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/oss/project/mngNasAppList"
				,"type" : "GET"
				,"data":function (d) {
	...
	function movePageDetail(projectBoxId, projectId, projectName, programSeq){
		...
		location.href = "${contextPath}/mng/project/persistentvolume/view"+params;
	}
