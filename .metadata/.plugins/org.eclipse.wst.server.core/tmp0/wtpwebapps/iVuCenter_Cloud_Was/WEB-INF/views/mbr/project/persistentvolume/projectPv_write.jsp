			...
			<div class="row pb50"">
				<div class="formType01">
					...
					<div class="tblWrap clearfix">
						<input type="hidden" id="hid_projectBoxId" value="${projectBoxId}">
...
<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					if(data.error == 1){
						...
						if(data.projectBoxId!=""){
							$("#hid_projectBoxId").val(data.projectBoxId);
	...
	function movePage(){
		var params="";
		if($("#hid_projectBoxId").val()==""){
			location.href = "${contextPath}/mng/project/disk/";
		}else{
			params = "?projectBoxId="+$("#hid_projectBoxId").val();
			params += "&projectName="+$("#projectName").val();
			location.href = "${contextPath}/mng/project/disk/view"+params;
		}
	}
