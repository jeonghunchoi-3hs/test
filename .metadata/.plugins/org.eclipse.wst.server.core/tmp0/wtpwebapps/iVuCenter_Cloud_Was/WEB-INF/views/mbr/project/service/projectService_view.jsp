	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 자원현황  <span class="arrow_ab"> &#8227; </span> <a href="${wasPath}/mbr/project/service/">서비스 </a></b> <span class="arrow_ab"> &#8227; </span> <b>서비스 상세 </b>
			    </span>
				</p>
				...
				<div class="row p20 bgwh br10">
				 ...
				 <div class="col-md-12 pl0 pr0">
            	   ...
            	   <div class="col-md-12 pl0 pr0 mt20">
            	     ...
            	     <div class="col-md-2 sub_use_service">컨테이너터미널<span class="flr"><em class="fc_purple_im f24 mr5" id="serviceTypeContainerTerminal">0</em>EA</span></div>
            	     </div>
		...
		<!-- 				<div class="page_searchBox m-b-15">
						...
						<!-- //상단 버튼  -->
						 ...
						 <div class="gridTableWrap gridType02 mt20">
					        ...
					        <table id="service-list" class="tableV">
									<colgroup>
										<col width="*">
										<col width="15%">
										<col width="15%">
						...
						<div class="modal fade" id="service-modal-dialog">
							<div class="modal-dialog">
			                   <div class="modal-content w560">
			                       <div class="modal-header">
			                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span></span></button>
			                           <h4 class="modal-title">서비스 자원 상세</h4>
			                       </div>
			                       <div class="modal-body">
													...
													<tr>
														...
														<td>
															<div class="flex align-center gap10">
																...
																<span class="pop_pid" id="infoProjectName">${req.projectName}</span>
															</div>
														</td>
													</tr>
													<tr>
														<th class="tal">프로젝트명</td>
														<td><span class="cnt" id="infoProjectAlias"></span></td>
													</tr>

													<tr>
														<th class="tal">자원ID</td>
														<td><span class="cnt" id="serviceId"></span></td>
													</tr>
													<tr>
														<th class="tal">승인일시</td>
														<td><span class="cnt" id="createDatetime"></span></td>
													</tr>
													<tr>
														<th class="tal">서비스신청명</td>
														<td><span class="cnt" id="serviceName"></span></td>
													</tr>
													<tr>
														<th class="tal">자원유형</td>
														<td><span class="cnt" id="serviceTypeName"></span></td>
													</tr>
													<tr>
														<th class="tal">자원명</td>
														<td><span class="cnt" id="resourceName"></span></td>
													</tr>
													<tr>
														<th class="tal">서비스내용</td>
														<td><textarea class="cnt" id="description" style="height:140px;" readonly></textarea></td>
													</tr>
												</tbody>
											</table>
										</div>
		...
		<script type="text/javascript">
			function detailService(projectId, serviceId, cloudName){
				$("#service-modal-dialog").modal();

				$.ajax({
					url : "${contextPath}/mbr/oss/service/mbrServiceDetailInfo",
					dataType : "JSON",
					data : {
						projectId : projectId
						,serviceId : serviceId
					...
					success : function(data) {
						...
						$.each(data, function(key, val){
							if(val != null) {
								...
								}else if(key == "projectAlias"){
									$("#infoProjectAlias").val(val);
									$("#infoProjectAlias").html(val);
								}
							}
				...
				location.href = "${contextPath}/mng/oss/project/write?projectId="+projectId;
					...
					function gridServiceList(){
						$("#service-list").dataTable( {
							...
							,"destroy" : true
							,"ajax": {
								"url":"${contextPath}/mbr/oss/service/mbrServiceDetail"
								,"type" : "GET"
								,"data":function (d) {
							...
							,"columns":[
								...
								, {"data":"serviceTypeName", "class":"tac" }
								, {"data":"serviceName", "class":"tac" }
								, {"data":"hostname" , "class":"tac"}
								, {"data":"createDatetime2" , "class":"tac"}
							]
							,"columnDefs":[
								{"defaultContent" : "", targets:"_all" }
				 				, {"targets":[6], "render": function(data,type,full){
				 					return '<a href="javascript:detailService(\''+full.projectId+'\',\''+full.serviceId+'\',\''+full.cloudName+'\');" class="cbton bton_lblue" onclick=""><i class="fa fa-search"></i></a>';
									}
								}
							]
							,"language": {
			...
			function excelDown(){
			    ...
			    location.href = "${contextPath}/mbr/oss/service/viewExcel?"+params;
			}
