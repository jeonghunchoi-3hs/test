	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				<!-- begin page-header -->
				<h1 class="page-header"><img src="<%=request.getContextPath()%>/resources/images/title_icon/basket.png"/>  신청<span class="root"> <img src="/resources/assets/img/root_icon.png"/> 콘솔 > 카달로그 > 부가자원</span></h1>
				<!-- end page-header -->
				...
				<div class="row mb50">
							...
							<div class="panel mb0">
								<div>
									<form name="orderform"  id="orderform" action="catalogueOrderNow.do" method="post" >
										...
										<input type="hidden" name="diskType" id="diskType" value="${ordervo.diskType}" />
									...
									<table class="tableAC table-td-valign-middle">
										...
										<tbody>
											<tr>
												...
												<td class="tac"> ${ordervo.projectAlias} </td>
												<td class="tac"> ${ordervo.vmName} </td>
												<td class="tac"> ${ordervo.diskcnt} GB </td>
												<td class="tar fcr fb"> ${ordervo.totalPrice} </td>
											</tr>
											<tr>
								         			...
								         			<table class="tableD4">
											 			...
											 			<tbody>
											 				<tr>
											 					...
											 					<td> ${ordervo.diskName} </td>
											 					<td> ${ordervo.diskcnt} GB </td>
					...
					<div class="col-md-12 tac p20 mt30">
						...
						<a type="button"><img src="/resources/assets/img/btn_order.png" onclick="valChk();"/></a>
						<a type="button"><img src="/resources/assets/img/btn_cancel.png"  class="ml10" onclick="moveVmPage();"/></a>
					</div>
				</div>
				<!-- end page-body -->
	...
	<script type="text/javascript">
			...
			function setJsonData(){
				...
				if(applyDatetime == ""){
					jsonData={
							"type" : $("#type").val()
							, "diskProductSeq" : $("#diskProductSeq").val()
							, "amount" : $("#amount").val()
			...
			function valChk(){
				...
				*/
				confirmBox("신청하시겠습니까?", catalogueOrderInsert);
				//openModal();
			}
			...
			function moveVmPage(){
				location.href="/mbr/req/catalogue/catalogueList.do";
			}
