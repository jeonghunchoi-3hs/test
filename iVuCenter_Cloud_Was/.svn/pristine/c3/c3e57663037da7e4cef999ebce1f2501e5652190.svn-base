	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer in">
		...
		<div id="content" class="content">
			<div class="page_header mb30">
				<h1>배포 현황(운영)</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">어플리케이션</a><a href="#" class="on">배포 현황(운영)</a>
				</div>
			</div>
				...
				<div class="row pb50">
					...
					<div class="orderArea">
						<div class="formType01">
							...
							<input type="hidden" name="h_envName" id="h_envName"	value="${prdPipeLine.envName}" />
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input class="form-control parameterClass" type="text" name="envAlias" id="envAlias" value="${prdPipeLine.envAlias}" readonly/>
...
<!-- 												</div> -->
						...
						<!-- 버튼박스 시작 -->
						<div class="btn_area">
<!-- 							<a type="button" class="btn_navy"  onclick="openApproveReviewModal();">재배포</a> -->
...
// 		$("#pop_label").text($("#label").val());
	...
	function moveListPage() {
		location.href="${wasPath}/mng/application/req/reqPrdDeployList"
	}
