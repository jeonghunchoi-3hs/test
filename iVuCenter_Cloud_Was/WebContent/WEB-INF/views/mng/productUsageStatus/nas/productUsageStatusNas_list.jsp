	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>NAS</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">NAS</a>
				</div>
			</div>
			<!-- end header -->
			...
			<div class="row pb50">
				...
				<div class="usageStatusWrap">
					...
					<dl>
						<dt>총 합계</dt>
						<dd class="type_03"><span class="title">DISK</span><span class="cnt" id='title_totalSize'><em>0</em>GB</span></dd>
					</dl>
				...
				<div class="gridTableWrap gridType03">
					...
					<div class="tableWrap m-t-15">
						...
						<!-- //상단 버튼  -->
						<table id="table-list" summary="NAS"> 
						<caption>게시판 목록 : 구분, 고객사명, 프로젝트명, NAS명, NAS용량, 과금단위, 자원가입일시</caption>
							<colgroup>
								<col width="127px">
								<col width="151px">
								<col width="185px">
							...
							<thead>
								<tr>
									...
									<th scope="col"><sapn class="fontVdn">NAS</sapn>명</th>
									<th scope="col"><sapn class="fontVdn">NAS</sapn>용량<em class="fontN fontVdn">(GB)</em></th>
...
<script type="text/javascript">
	...
	function gridList(act) {
		...
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/productUsageStatus/nas/list"
				,"type" : "GET"
				,"data":function (d) {
			...
			,"initComplete" : function(setting, json){
				 $("#title_totalSize em").text(json.totalSize);
			...
			,"columns":[ 
				...
				, {"data":"nasName" , "class":"tal onwrap"}
				, {"data":"nasGb" , "class":"tar onwrap fontVdn p-r-20"}
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/productUsageStatus/nas/excel?'+params;
	}
	...
	$(document).ready(function() {
		...
		$("#productUsageStatusNas").addClass("active");
	});
</script>
</body>
</html> 