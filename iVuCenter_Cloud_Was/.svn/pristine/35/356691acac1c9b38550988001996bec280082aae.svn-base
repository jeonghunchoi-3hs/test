	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>블록디스크</h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">블록디스크 관리</a>
				</div>
			</div>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"columns":[
				...
				, {"data":"managerTelEx"}
				, {"data":"managerPhone"}
			//	, {"data":"diskGb" , "class":"tal fontVdn p-r-30"}
				, {"data":"diskCnt" , "class":"tar","render":function (data,type,full,meta){
	...
	function movePageDetail(projectBoxId, projectName, programSeq){
		...
		location.href = "${contextPath}/mng/project/disk/view" + encodeURI(params);
	}
