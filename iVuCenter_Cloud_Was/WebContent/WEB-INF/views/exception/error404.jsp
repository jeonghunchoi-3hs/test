...
if (requestUri != null && !requestUri.equals("/favicon.ico")) {
...
<head>
	...
	<!-- Fonts -->
	<link type='text/css' rel="stylesheet" href="<%=request.getContextPath()%>/resources/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<title>error</title>
</head>
	    ...
	    <div class="row">
	        <div class="col-sm-6 col-md-4 col-md-offset-4">
	            ...
	            <div class="account-wall">
					...
					<div class="row">
	                    <div class="col-lg-12">
	                    	<c:if test = "${userIp ne null}">
	                    	<h1 class="" style='text-align:center'><small>등록되지 않은 IP입니다.</small><br/>${userIp}</h1>	 
	                    	</c:if>
	                    	<c:if test = "${userIp eq null}">
