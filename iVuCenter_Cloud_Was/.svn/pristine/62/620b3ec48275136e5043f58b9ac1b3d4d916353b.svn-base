			 ...
			 <div class="col-md-12 br5 p30 mb20 bgee">
					...
					<!-- 블록디스크 리스트 -->
						...
						<div class="tar" style="margin-bottom:-20px;">
							...
							<table id="table-list-fs" class="tableV">
								<colgroup>
									<col width="150px">
									<col width="150px">
									<col width="150px">
		...
		<script type="text/javascript">
			...
			function gridList() {
				$("#table-list-fs").dataTable( {
					...
					,"destroy" : true
					,"ajax": {
						"url":"${contextPath}/mbr/oss/project/mbrFsList"
						,"type" : "GET"
						,"data":function (d) {
			...
			//	tblColorSet();
				...
				//	}
					function movePageDetail(projectBoxId, projectId, projectName, programSeq){
						...
						location.href = "${contextPath}/mbr/project/filestorage/view"+params;
					}
					...
					function excelDown(){
					    ...
					    params += "&customerId=";
					    location.href =  '${contextPath}/mbr/oss/project/mbrOssFSExcel?'+params;
					}
