...
<html lang="ko">
	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<p class="page_title">자원 요청 현황  상세
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 신청 현황  <span class="arrow_ab"> &#8227; </span> <a href="${wasPath}/mbr/req/catalogue/bssOrderList">자원 요청 현황 </a> <span class="arrow_ab"> &#8227; </span> <b> 자원 요청 현황 상세 </b>
			    </span>
			</p>
			...
			<!-- 2023 New 승인  시작 -->
				...
				<!-- 2023 New 승인  끝-->
					...
					<div class="client_DetailArea mt20">
						<!-- 프로젝트 정보
						<span class="pid">${projectInfo.projectName}</span><h3  class="pname dpin ml20">${projectInfo.projectAlias} </h3>
						<div class="clear"></div>
						<h4 class="ptxt_t">클라우드</h4>
						<%--pageContext.setAttribute("newLineChar","\n"); pageContext.setAttribute("br","<br/>");--%>
						<p class="ptxt">${projectInfo.cloudName}</p>
						<div class="mt20">
				 			<span class="dpin fb fc-blue2">회원사  : </span> <span id="companyName">${projectInfo.customerName}</span><span class="dpin fb ml40 fc-blue2">담당조직(부서) : </span> <span>${projectInfo.deptName} </span><span class="dpin fb ml40 fc-blue2">담당자  : </span> <span>${projectInfo.customerName}(${projectInfo.managerTel})</span>
				 		</div>
					</div>
...
<%-- 					<table class="tableH4">
					...
					<tbody>
						<tr>
							<th colspan="8" class="f18"><span class="pid" id="projeectAlias">${projectInfo.projectName}</span>
							<h3 class="pname dpin ml20">${projectInfo.projectAlias}</h3></th>
						</tr>
						<tr>
							...
							<td>${projectInfo.customerName}(${projectInfo.managerTel})</td>
						</tr>
					</tbody>
					</table> --%>
							...
							<div>
								<table class="sumtableV">
									...
									<tbody>
										...
										<tr>
											<td class="tal">서비스 (계정관리/보안관제/백업관리/SW설치/디스크관리/오토스케일/app재배포)</td>
											<td>${servNew}</td>
											<td>${servCh}</td>
											<td>${servEx}</td>
				...
				<h2 class="sub_title mt30">신청내역  </h2>
				<button class="a-ccordion up">기본자원 (가상서버) <div class="sum"><ul><li >신규    <span class="fc_dblue">${vmNew} </span></li> <li>변경   <span class="fc-green"> ${vmCh}</span> </li><li>삭제   <span class="fc-orange"> ${vmEx}</span> </li></ul></div> </button>
				<div class="re_subbox">
				  <p>
												...
												<table class="tableV">
													...
													<c:choose>
														...
														<tr class="even">
															...
															<td class="tacl"> ${orderviewList.hostnameAlias} </td>
												 						...
												 						<tbody>
												 							...
												 							<tr>
												 								...
												 								<td colspan="2" class="tal pl20">
												 									아이뷰센터 쇼핑몰에서 외부 연결되는 가상머신입니다.  빠른 승인 조치바랍니다.
...
<!-- 																<th scope="col">신청금액(원)</th> -->
												...
												<%-- 				<td class="tac">
																...
																<td class="tac">
																	<button type="button" class="cbton bton_lblue" onclick="openPopNas('${orderNasviewList.projectAlias}',
																	...
																	'${orderNasviewList.cloudType}', '${orderNasviewList.cloudName}', '${orderNasviewList.nasFileSystemPath}', '${orderNasviewList.changeNasGb}')" >
																	<span></span><i class="fa fa-search"></i></button>
...
<%-- 								</c:if> --%>
				...
				<button class="a-ccordion up" style="margin-top:20px;">어플리케이션<div class="sum"><li >신규    <span class="fc_dblue"> ${serAppNew} </span></li> <li>변경   <span class="fc-green"> ${serAppCh}</span> </li><li>삭제   <span class="fc-orange"> ${serAppEx}</span> </li></div>  </button>
				<div class="re_subbox">
				  <p>
								...
								<table class="tableV" summary="자원 신청현황 자원정보">
									...
									<tbody>
										...
										<tr>
											...
											<td class="tac"><button type="button" class="cbton bton_lblue" onclick="openPopEnv('${orderEnvviewList.cloudName}','${orderEnvviewList.projectName}','${orderEnvviewList.projectAlias}','${orderEnvviewList.productCategoryName}','${orderEnvviewList.envAlias}','${orderEnvviewList.description}','${orderEnvviewList.orderProductSeq}');"><i class="fa fa-search"></i></button></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
...
<%-- 						<!-- 상세 보기 버튼 -->
						...
						<a href="#" type="button" class="btn_dgrey" onclick="moveListPage()"> 목록</a>
				        </div>
				</div>
		                       	...
		                       	<div class="modal-body">
		                       		...
		                       		<div class="bottomArea" id="popDetailDiv2">
		                       			<div class="fl mr20 tac">
		                       				<p class="cpuArea nanumR mb5 f20">36</p>
		                       				<p class="fc11">vCPU<span class="fc66 fn">(Core)</span></p>
		                       			</div>
		                       			<div class="fl mr20 tac">
		                       				<p class="memoryArea nanumR mb5 f20">63</p>
		                       	...
		                       	<div class="modal-body">
		                       		...
		                       		<div class="bottomArea"  id="blockDetailDiv2">
		                       			...
		                       			<div class="fl tac center w30">
		                       				<p class="diskArea nanumR mb5 f20">999</p>
		                       				<p class="fc11">DISK<span class="fc66 fn">(GB)</span></p>
		                       			</div>
		                       			<div class="fl bottomAreaDetail tal">
...
<!-- 			nas 상세 -->
				       ...
				       <div class="modal-content">
				           ...
				           <div class="modal-body">
				               ...
				               <div class="bottomArea" id="nasPopDetailDiv2">
				                   <div class="fl mr20 tac">
				                       <p class="cpuArea nanumR mb5 f20">4</p>
				                       <p class="fc11">vCPU<span class="fc66 fn">(Core)</span></p>
				                   </div>
				                   <div class="fl mr20 tac">
				                       <p class="memoryArea nanumR mb5 f20">16</p>
				                       <p class="fc11">MEMORY<span class="fc66 fn">(GB)</span></p>
				                   </div>
				                   <div class="fl tac">
				                       <p class="diskArea nanumR mb5 f20">500</p>
				                       <p class="fc11">DISK<span class="fc66 fn">(GB)</span></p>
				                   </div>
				                   <div class="fl bottomAreaDetail tal">
				                       <li><span class="fc11">요청유형 :</span><span class="fc66 nanumR">신규</span></li>
	...
	/* 	//마지막 승인 버튼 누를시
		...
		function moveViewPage(){
			//location.reload();
			location.href = "${wasPath}/mbr/req/catalogue/bssOrderView?orderNo=${orderNo}";
		}
		...
		// 목록 페이지이동
	//	function moveListPage(){
			//location.href = "${wasPath}/mbr/bbs/notice/";
		//	location.href = "bssOrderList";
	//	}
...
/* 		$("#blockDetailDiv1").html('<p>'
				...
				+'</p>'
				+'<p class="fl mt10 clear">'
				+'<span class="serverPopLabel3">디스크 TYPE</span><span class="fc11 ml5">'+diskType+'</span>'
				+'</p>'
				+'<p class="fl mt10 clear">'
				+'<span class="serverPopLabel3">요청유형</span><span class="fc11 ml5">'+requestName+'</span>'
			+'</p>'); */
		...
		$("#blockDetailDiv1").html('<table class="m_table">'
				...
				+'<tr><th>디스크TYPE</th><td>'+diskType+'</td></tr>'
				+'<tr><th>요청유형</th><td>'+requestName+'</td></tr>'
				+'<tr><th>요청내용</th><td>'+description+'</td></tr>'
				+'</tbody>'
			+'</table>');
...
/* 					+'<ul class="mt30">'
	...
	function openPopNas(projectAlias, nasName, vmName, requestName, hourlyFlag, onDemandFlag, applyDatetime, nasGb, amount, description, nasVmList, nasAlias, nasOption, cloudType, cloudName, nasFileSystemPath, changeNasGb) {
	    if(description == ''){
	        description = "요청내용이 없습니다.";
	    }
	    ...
	    if(requestName == '변경'){
	        $("#nasPopDetailDiv2").html(
	            ...
	            + (nasGb == null ? "" : '<p class="cpuArea nanumR mb5 f20 center">' + changeNasGb + '</p>')
...
// 		}
		...
		function openPopEnv(cloudName,projectName,projectAlias,productCategoryName,envAlias,description,orderProductSeq){
			if(description == ''){
		...
		function openPopService(projectName,description, serviceProductName, serviceName, serviceTypeName, projectAlias, hostname, hostnameAlias, requestName, hourlyFlag, onDemandFlag, applyDatetime, amount, cloudName) {
...
/* 			$("#serviceDetailDiv1").html('<p>'
					...
					+'</p>'
					+'<p class="fl mt10 clear">'
					+'<span class="serverPopLabel3">서비스명</span><span class="fc11 ml5">'+serviceProductName+'</span>'
					+'</p>'
					+'<p class="fl mt10 clear">'
			...
			$("#serviceDetailDiv1").html('<table class="m_table">'
					...
					+'<tr><th>서비스 희망일시</th><td>'+(onDemandFlag == "N"?applyDatetime:"승인완료 후")+'</td></tr>'
					+'<tr><th>서비스명</th><td>'+serviceProductName+'</td></tr>'
					+'<tr><th>가상서버</th><td>'+hostname+'</td></tr>'
					+'<tr><th>요청유형</th><td>'+requestName+'</td></tr>'
					+'<tr><th>요청내용</th><td>'+description+'</td></tr>'
					+'</tbody>'
				+'</table>');
...
// 		}
		...
		$(document).ready(function() {
			...
			$("#goodsReqStatus").addClass("active");
