	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>대외계 서비스</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">대외계 서비스</a>
				</div>
			</div>
			<!-- end header -->
			...
			<div class="usageStatusWrap">
				...
				<dl>
					<dt>총 합계</dt>
					<dd class="type_01 bgNone">&nbsp;</dd>
				</dl>
				<div class="total" id="mcaTotal"><em>0</em>EA</div>
			</div>
			<!-- //Usage Status -->
			...
			<div class="gridTableWrap gridType03">
				...
				<div class="tableWrap m-t-15">
					...
					<!-- //상단 버튼  -->
					<table id="table-list" summary="대외계 서비스"	> 
						<caption>게시판 목록 : 구분, 고객사명, 프로젝트명, 과금단위, 자원 가입일시로 구성</caption> 
						<colgroup>
							<col width="127px">
							<col width="228px">
							<col width="294px">
						...
						<!-- <tbody>
							<tr>
								<td class="txtNormal tal">쓰리에이치에스</td>
								<td class="txtNormal tal">솔루션사업부</td>
								<td class="txtNormal tal">프로젝트1</td>
								<td class="txtNormal tac">월</td>
								<td class="fontVdn txtNormal tac">2017-09-18 11:11</td>
							</tr>
							<tr>
								<td class="txtNormal tal">쓰리에이치에스</td>
								<td class="txtNormal tal">솔루션사업부</td>
								<td class="txtNormal tal">프로젝트</td>
								<td class="txtNormal tac">월</td>
								<td class="fontVdn txtNormal tac">2017-09-18 11:11</td>
							</tr>
						</tbody> -->
...
<script type="text/javascript">
	...
	function gridList(act) {
		...
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/productUsageStatus/mca/list"
				,"type" : "GET"
				,"data":function (d) {
			...
			,"initComplete" : function(setting, json){
				$("#mcaTotal em").text(json.recordsTotal);
			}
			,"columns":[ 
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/productUsageStatus/mca/excel?'+params;
	}
	...
	$(document).ready(function() {
		...
		$("#productUsageStatusMca").addClass("active");
	});
</script>
</body>
</html>