	    ...
	    <h3 class="subtitle"><i class="fa fa-cloud f18"></i> 공지사항</h3>
		 ...
		 <!-- search begin -->
			...
			<!-- 테이블시작 -->
				...
				<div class="panel">
				    <div class="mb50">
				        <table class="tableV" id="noticeBbsList">
							<colgroup>
								<col width="8%">
								<col width="10%">
								<col width="*">
...
// 						location.reload();
			...
			,"columnDefs":[
				...
				, {"targets":[2], "render": function(data,type,full){
					return "<a href='#' onclick='moveDetailPage(\""+full.noticeNo+"\")'>" + full.title + "</a>";
					}	
				}
				//, {"targets":[6], "render": function(data,type,full){
				//	return "<button type='button' class='btn btn-grey_01' onclick='moveDetailPage(\""+full.noticeNo+"\")' ><i class='fa fa-search'></i></button>";
				//	}	
				//}
			]
			,"order": [[0,"desc"]]
	...
	function moveDetailPage(noticeNo){
		location.href = "${contextPath}/homepage/noticeView?noticeNo="+noticeNo;
	}
