							...
							<tr>
								...
								<td>
										<div class="optionBox w114">
											<label><input type="checkbox" id="WF3000A0" name='auth' value='Y'><span>요청부서검토</span></label>
											<label><input type="checkbox" id="WF3000B0" name='auth' value='Y'><span>요청부서승인</span></label>
											<label><input type="checkbox" id="WF3000C0" name='auth' value='Y'><span>요청부서승인</span></label>
											<label><input type="checkbox" id="WF3000D0" name='auth' value='Y'><span>승인부서검토</span></label>
											<label><input type="checkbox" id="WF3000E0" name='auth' value='Y'><span>승인부서승인</span></label>
										</div>
									</td>
							</tr>
								<tr>
...
<script type="text/javascript">
	...
	function moveListPage(){
		location.href = "${contextPath}/mbr/operation/approveUser/approve.do";
	}
	...
	function actUpdate(){
		$.ajax({
			...
			data : {
				...
				, "WF3000C0" : $("input:checkbox[id='WF3000C0']").is(":checked")?"Y":"N"
				, "WF3000D0" : $("input:checkbox[id='WF3000D0']").is(":checked")?"Y":"N"
				, "WF3000E0" : $("input:checkbox[id='WF3000E0']").is(":checked")?"Y":"N"
