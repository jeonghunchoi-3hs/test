	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>서비스 관리</h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">서비스 관리</a>
				</div>
			</div>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/oss/project/projectServiceList"
				,"type" : "GET"
				,"data":function (d) {
			...
			,"columns":[
				...
				, {"data":"projectAlias" , "class":"tal name overflow-path"}
				, {"data":"managerName"}
				, {"data":"managerTelEx"}
				, {"data":"managerPhone"}
				, {"data":"serviceCnt" , "class":"tar","render":function (data,type,full,meta){
			...
			,"columnDefs":[
				...
				, {"targets":[9], "render": function(data,type,full){
					return "<a href='javascript:void(0);' class='cbton bton_lblue'  onclick='movePageDetail(\""+full.projectBoxId+"\",\""+full.projectName+"\",\""+full.programSeq+"\",\""+full.cloudName+"\")'><i class='fa fa-search'></i></a>";
					}
				}
			]
			,"language": {
	...
	function movePageDetail(projectBoxId, projectName, programSeq){
		var params = "?projectBoxId="+projectBoxId;
		params += "&projectName="+projectName;
		params += "&programSeq="+programSeq;
		location.href = "${contextPath}/mng/project/service/serviceView" + encodeURI(params);
	}

	function moveInsertPage(){
		location.href = "${contextPath}/mng/project/vm/serviceWrite";
	}
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/oss/project/serviceExcel?' + encodeURI(params);
	}
