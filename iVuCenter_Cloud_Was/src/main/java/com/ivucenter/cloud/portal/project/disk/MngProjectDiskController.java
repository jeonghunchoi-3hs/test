...
@Controller
@RequestMapping(value="/mng/project/disk")
public class MngProjectDiskController {
	...
	public String MngProjectDisk(Model model) {
		...
		return "mng/project/disk/projectDisk_list";
	}

	@RequestMapping(value="/view")
	public String MngProjectDiskView(Model model, CustomOssProjectVO req) {
		model.addAttribute("req", req);
		return "mng/project/disk/projectDisk_view";
	}
...
//		model.addAttribute("projectId", req.getProjectId());
		...
		return "mng/project/disk/projectDisk_write";
	}
}
