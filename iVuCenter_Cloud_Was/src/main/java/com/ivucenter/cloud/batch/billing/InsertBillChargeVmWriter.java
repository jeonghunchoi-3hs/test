...
public class InsertBillChargeVmWriter implements ItemWriter<BatchBillChargeVmVO> {

	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String insertBillChargeVm 	= batchBillingDAO + "insertBillChargeVm";
...
//        this.billYM = (String) this.parameterValues.get("billYM");
        ...
        for (BatchBillChargeVmVO item : items) {
        	...
        	this.sqlSessionTemplate.insert(insertBillChargeVm, item);
        }
