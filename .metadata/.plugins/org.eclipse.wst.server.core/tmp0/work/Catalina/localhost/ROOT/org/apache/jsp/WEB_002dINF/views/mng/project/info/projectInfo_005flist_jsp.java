 ...
 * Generated at: 2025-03-07 00:09:43 UTC
...
public final class projectInfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(11,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f0.setVar("contextPath");
        // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(11,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      ...
      out.write("										<option value=\"project_alias\">프로젝트 설명</option>\r\n");
      out.write("										<option value=\"project_name\">프로젝트명</option>\r\n");
      out.write("										<option value=\"manager_name\">담당자 명</option>\r\n");
      out.write("									</select>\r\n");
      out.write("								</div>\r\n");
      out.write("								<input type=\"text\" placeholder=\"검색어를 입력하세요\" id=\"keyword\"\r\n");
      out.write("									onkeypress=\"if(event.keyCode==13)gridList();\" class=\"width-600 ml5\">\r\n");
      ...
      out.write("												<th>처(실)</th>\r\n");
      out.write("												<th>부서</th>\r\n");
      out.write("												<th>프로젝트 ID</th>\r\n");
      out.write("												<th>프로젝트 명</th>\r\n");
      out.write("												<th>담당자</th>\r\n");
      ...
      out.write("/mng/oss/project/list\"\r\n");
      out.write("							,\"type\" : \"GET\"\r\n");
      ...
      out.write("						}\r\n");
      out.write("						,\"columns\":[\r\n");
      out.write("							{\"data\":\"deptName\"}\r\n");
      out.write("							, {\"data\":\"deptName\"}\r\n");
      out.write("							, {\"data\":\"deptName\"}\r\n");
      out.write("							, {\"data\":\"projectName\" , \"class\":\"tal\"}\r\n");
      out.write("							, {\"data\":\"projectAlias\" , \"class\":\"tal name\"}\r\n");
      out.write("							, {\"data\":\"managerName\"}\r\n");
      out.write("							, {\"data\":\"managerTelEx\"}\r\n");
      out.write("							, {\"data\":\"managerPhone\"}\r\n");
      out.write("							, {\"data\":\"regDatetime\" ,\"render\":function (data,type,full,meta){\r\n");
      out.write("								return '<span title =\"'+data.substr(0,10)+'\">'+data.substr(0,10)+'</span>';\r\n");
      out.write("							}}\r\n");
      out.write("							/* , {\"data\":\"deleteFlag\" , \"class\":\"tac\"}\r\n");
      out.write("							, {\"data\":\"\" , \"class\":\"tac\"}\r\n");
      out.write("					        , {\"class\":\"tac\", \"width\":\"65px\"}  */\r\n");
      out.write("						]\r\n");
      ...
      out.write("								<!--return \"<a href='javascript:void(0);' class='btn_viewDetail'  onclick='movePageDetail(\\\"\"+full.projectId+\"\\\",\\\"\"+full.projectName+\"\\\")'></a>\";-->\r\n");
      out.write("								return \"<a href='javascript:void(0);' class='cbton bton_lblue'  onclick='movePageDetail(\\\"\"+full.projectBoxId+\"\\\",\\\"\"+full.projectName+\"\\\",\\\"\"+full.projectAlias+\"\\\",\\\"\"+full.programSeq+\"\\\")'><i class='fa fa-search'></i></a>\";\r\n");
      out.write("\r\n");
      out.write("								}\r\n");
      out.write("							}\r\n");
      out.write("\r\n");
      ...
      out.write("							, \"processing\":\"<div style='background-color:#fff;padding-top:50px;padding-bottom:50px;'><p align='center' style='color:#888; font-weight:bold;'>검색중입니다.</p></div>\"\r\n");
      out.write("						}\r\n");
      ...
      out.write("				}\r\n");
      out.write("\r\n");
      out.write("				function movePageDetail(projectBoxId, projectName, projectAlias, programSeq){\r\n");
      out.write("					var params = \"?reqProjectSeq=\"+programSeq;\r\n");
      out.write("					      params += \"&projectBoxId=\"+projectBoxId;\r\n");
      out.write("\r\n");
      out.write("					location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/mng/project/info/view\" + encodeURI(params);\r\n");
      out.write("				}\r\n");
      out.write("\r\n");
      out.write("				function moveInsertPage(){\r\n");
      out.write("					location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/mng/project/info/write\";\r\n");
      out.write("				}\r\n");
      out.write("\r\n");
      ...
      out.write("					location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/mng/oss/project/mngProjectInfoExcel?\" + encodeURI(params);\r\n");
      out.write("				}\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(7,0) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(8,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_sec_005fauthentication_005f0.setVar("userId");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(8,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(9,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_sec_005fauthentication_005f1.setVar("userName");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(9,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(21,2) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fimport_005f0.setUrl("/WEB-INF/views/mng/include/import.jsp");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(21,2) name = charEncoding type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(29,3) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fimport_005f1.setUrl("/WEB-INF/views/mng/include/header.jsp");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(29,3) name = charEncoding type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(33,3) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fimport_005f2.setUrl("/WEB-INF/views/mng/include/sidebar.jsp");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(33,3) name = charEncoding type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(112,6) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fimport_005f3.setUrl("/WEB-INF/views/mng/include/footer.jsp");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(112,6) name = charEncoding type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(120,3) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fimport_005f4.setUrl("/WEB-INF/views/mng/include/script.jsp");
      // /WEB-INF/views/mng/project/info/projectInfo_list.jsp(120,3) name = charEncoding type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
