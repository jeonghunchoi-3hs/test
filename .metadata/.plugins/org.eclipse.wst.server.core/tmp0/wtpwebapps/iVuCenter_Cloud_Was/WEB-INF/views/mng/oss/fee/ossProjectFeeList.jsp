...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			<!-- begin header -->
			<h1 class="page-header fc66"> <i class="fa fa-dot-circle-o fcb"> </i> 프로젝트 요금 관리 <span class="root">프로젝트 관리 > 요금 관리</span></h1>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function movePageDetail(projectId, projectName){
		...
		location.href = "${contextPath}/mng/project/fee/view"+params;
	}
	
	function moveInsertPage(){
		location.href = "${contextPath}/mng/project/fee/write";
	}
