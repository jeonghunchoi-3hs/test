...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer in">
		...
		<!-- begin #content -->
		<form name="catalogueform"  id="catalogueform" action="catalogueApp" method="post" >
		...
		<div id="content" class="content">
				<p class="page_title">
					...
					<span class="root f14">
						...
						<span class="text arrow mint"><strong>어플리케이션 이용현황</strong></span>
					</span>
				</p>
										...
										<tr>
											...
											<td>
												<div class="search-box w100">
													...
													<img src="/resources/assets/img/btn_search2.png" onclick="openModal();" class="kepco-ser-icon">
<!-- 												<img src="/resources/assets/img/icon_search.png" onclick="openModal();" class="input_search t10 r0"/> -->
												</div>
											</td>
											<td class="left">서버대역 </td>
											<td>
<!-- 												<select class="search-sel form-select" name="cloudInfo" id="cloudInfo" onChange="selectCloud();"> -->
										...
										<tr>
											...
											<td>
												<input maxlength="30" class="form-control parameterClass" name="appName" id="appName" type="text"/>
											</td>
											<td class="left">버전</td>
											<td>
												<div class="searchBoxArea">
...
<%-- 														</c:forEach> --%>
										...
										<!-- <tr>
											<td class="left">Application 별칭 </td>
											<td><input maxlength="30" class="form-control width-540" name="appNameProject"  id="appNameProject" type="text"/></td>
										</tr> -->
										<tr>
											<td class="left" >Git Repository URL</td>
											<td>
												<input class="form-control parameterClass" type="text" name="gitRepository" id="gitRepository"/>
											</td>
										</tr>
										<tr>
											<td class="left" scope="row">컨테이너사양</td>
											<td class="depth-dropdown-box">
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td><span class="cnt" id="pop_appNameAlias"></span></td>
												</tr>
												<tr>
...
// 						Html="<tr><td class='tac'>"+val["projectName"]+"</td>";
						...
						Html = Html + "<td>"+val["projectAlias"]+"</td>";
