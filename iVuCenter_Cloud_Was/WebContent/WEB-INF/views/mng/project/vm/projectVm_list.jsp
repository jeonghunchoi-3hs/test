	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1 id="titleText"></h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on" id="titleLinkText"></a>
				</div>
			</div>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"columns":[
				...
				, {"data":"vmCnt" , "class":"tar","render":function (data,type,full,meta){
	...
	function moveInsertPage(){
		location.href = "${contextPath}/mng/project/vm/write";
	}
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/oss/project/vmExcel?'+params;
	}
