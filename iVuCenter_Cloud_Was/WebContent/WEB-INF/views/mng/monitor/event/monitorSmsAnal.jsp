...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			<!-- begin header -->
			<h1 class="page-header fc66"><img src="${contextPath}/resources/images/title_icon/monitor.png"/>  SMS 분석/리포팅  <span class="root"> <img src="/resources/assets/img/root_icon.png"/> 콘솔 > 모니터링 </span></h1>
			<!-- end header -->
			...
			<div class="row mb50">
				...
				<div class="col-md-12">
					<div id="zenius01">
						<iframe class="w100" style="height: 650px;" src="http://10.220.211.200/zenius61/common/login.action?_m=loginLink&userid=testuser&pageUrl=/sms/smsAdmin.action?&pageParam=_m_eq_getAnalMain"></iframe>					
					</div>
