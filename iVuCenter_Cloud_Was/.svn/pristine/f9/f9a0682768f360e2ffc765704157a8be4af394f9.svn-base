...
@Setter
@ToString
public class SmsQueueVO extends DataTableVO{

    private static final Logger logger = LoggerFactory.getLogger(SmsQueueVO.class);

	private String smsSeq;			// now + UUID
	private String smsShortSeq; 	// 15 byte 숫자 고유번호  (kepco 에서 필요)
	private String templateId;		// SMS00 + gbn (33,55,21,...)
	private String templateName;
	private String senderName;		// 발신자 이름
	private String senderNumber;	// 발신자 번호
	private String receiverFlg;		// 수신자 구분  (U: 사용자/USERRECEIVERFLG, C: 회원사/CUSTOMERRECEIVERFLG)
	private String receiverId;		// 수신자 ID (사번)
	private String receiverName;	// 수신사 이름
