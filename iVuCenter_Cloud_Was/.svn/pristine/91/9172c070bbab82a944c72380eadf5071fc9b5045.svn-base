...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			<!-- begin header -->
			<h1 class="page-header fc66"> <i class="fa fa-dot-circle-o fcb"> </i> 메일 템플릿 목록<span class="root">관리자포털 > 메일 > 메일 템플릿 </span></h1>
			<!-- end header -->
...
/* 				, {"targets":[2], "render": function(data,type,full){
	...
	function movePageDetail(templateId){
		...
		location.href = "${contextPath}/mng/mail/template/view"+params
	}
 
 	
 	function moveInsertPage(){
 		location.href = "${contextPath}/mng/mail/template/write";
 	}
