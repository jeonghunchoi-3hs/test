...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			 ...
			 <p class="page_title">배포현황(개발)
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span>
						<a href="${wasPath}/mbr/main"> 콘솔</a>
				<span class="arrow_ab"> &#8227; </span> 개발환경  <span class="arrow_ab"> &#8227; </span>
				<b><a href="${wasPath}/mbr/application/req/">배포현황(개발)</a> </b>
			    </span>
			</p>
...
<script type="text/javascript">
	...
	function movePageDetail(cicdProjectId, pipelineId, projectBoxId, appName){
		...
		location.href = "${contextPath}/mbr/application/req/catalogueDevExportDetail"+params;
	}
