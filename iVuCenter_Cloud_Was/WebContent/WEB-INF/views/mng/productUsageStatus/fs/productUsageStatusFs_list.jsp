		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<div class="page_header mb30">
					<h1>FS</h1>
					<div class="pageNav">
						<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">FS</a>
					</div>
				</div>
				<!-- end header -->
		...
		<script type="text/javascript">
			...
			function gridList(act) {
				...
				$("#table-list").dataTable({
					...
					,"destroy" : true
					,"ajax": {
						"url":"${contextPath}/mng/productUsageStatus/fs/list"
						,"type" : "GET"
						,"data":function (d) {
			...
			function excelDown(){
				...
				location.href =  '${contextPath}/mng/productUsageStatus/fs/excel?'+encodeURI(params);
			}
			...
			$(document).ready(function() {
				...
				$("#productUsageStatusFs").addClass("active");
