...
public class UpdateBillChargeDiskForAmountWriter implements ItemWriter<BatchBillChargeDiskVO> {	


	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String updateAmountForBillChargeDisk 	= batchBillingDAO + "updateAmountForBillChargeDisk";
...
//        this.baseBillEndDate = (Date) this.parameterValues.get("baseBillEndDate");
        ...
        for (BatchBillChargeDiskVO item : items) {
        	this.sqlSessionTemplate.update(updateAmountForBillChargeDisk, item);
        }
