...
public class ProvisioningJobLauncherDetails extends QuartzJobBean{
    
    private static final String SPRING_BATCH_JOB_NAME = "provisioningJob";
     
    @Override
    protected void executeInternal(JobExecutionContext context){
        
    	log.debug("---------------------ProvisioningJobLauncherDetails------------------------"); 
