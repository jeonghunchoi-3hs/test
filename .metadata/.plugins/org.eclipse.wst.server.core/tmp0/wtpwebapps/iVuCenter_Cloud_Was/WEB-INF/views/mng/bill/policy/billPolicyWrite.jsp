					...
					<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="col-md-10">
											 <button type="button" class="btn btn-primary width-80" onclick="billpolicywrite();">등록</button>
											 <button type="button" class="btn btn-grey width-80" onclick="movePage();">목록</button>
										</div>
									</td>
								</tr>
								 -->
...
// 		});
	...
	function movePage(){
		location.href="/mng/bill/policy/billPolicyList.do";
	}
