	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>PV 관리 상세</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">PV 관리</a>
				</div>
			</div>
			<!-- end header -->
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td><span id="modal_projectAlias"></span></td>
											</tr>
											<tr>
												<th class="tal">스토리지ID</td>
												<td><span class="cnt nanumR" id="modal_nasName"></span></td>
											</tr>
											<tr>
												<th class="tal">스토리지명</td>
												<td><span class="cnt" id="modal_nasAlias"></span></td>
											</tr>
											<tr>
												<th class="tal">파일 경로</td>
												<td><span class="cnt" id="modal_nasFileSystemPath"></span></td>
											</tr>
											<tr>
												<th class="tal">어플리케이션</td>
												<td><span class="cnt" id="modal_appName"></span></td>
											</tr>
											<tr>
												<th class="tal">mountPath</td>
												<td><span class="cnt" id="modal_mountPath"></span></td>
											</tr>
										</tbody>
									</table>
									<p class="commnet fc-red tac">연결을 해지하시겠습니까?</p>
								</div>
		                   	</div>
		...
		//		type : "POST",
			...
			success : function(data) {
				...
				$.each(volumeList,function(key,val){
					if (val["projectId"] == 'ALL') {
						...
						projectHtml += "			<td class='tar'>"+addcomma(val["nasUsed"])+"</td>";
						projectHtml += "		</tr>";
						projectHtml += "		<tr>";
			...
			function gridNasList(){
				$("#nas-list").dataTable( {
					...
					,"destroy" : true
					,"ajax": {
						"url":"${contextPath}/mng/oss/persistentvolume/nasList"
						,"type" : "GET"
						,"data":function (d) {
			...
			function detailNas(nasName,nasAlias,orderProductSeq,nasGb,nasFileSystemPath,description,amount,nasVmList,cloudName,projectAlias){
				...
				html += "<tr><th class='left-t'>프로젝트명</th><td>"+ projectAlias +"</td></tr>"
				html += "<tr><th class='left-t'>스토리지ID</th><td>" + nasName + "</td></tr>"
				html += "<tr><th class='left-t'>스토리지명</th><td>" + nasAlias + "</td></tr>"
				html += "<tr><th class='left-t'>클러스터명</th><td>" + cloudName + "</td></tr>"
					html += "<tr><th class='left-t'>파일 경로</th><td>" + nasFileSystemPath + "</td></tr>"
				html += "</tbody></table></div>"

				// NAS 용량
				html += '<div class="bottomArea clearfix" style="border-bottom:0;">';
...
// 					}
			...
			function excelDown() {
			    ...
			    location.href = "${contextPath}/mng/oss/persistentvolume/excel?"+params;
			}
			...
			function moveListPage(){
				location.href = "${contextPath}/mng/project/persistentvolume/";
			}
