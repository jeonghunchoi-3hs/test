...
<html lang="ko">
	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<p class="page_title">자원 요청 현황
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 신청 현황  <span class="arrow_ab"> &#8227; </span> <b> 자원 요청 현황 </b>
			    </span>
			</p>


				<!-- begin contetn > page-body -->
				<div class="row p20 bgwh br10">
					<p class="fc-99">현재까지 신청한 모든 데이터입니다.</p>
					<!--  검색이 문서에 없음  검색을 지우면 날짜가 변수처리 되어있어서 화면이 깨짐 따라서 style 로 display:none 해놓은 것임!!  -->
					<!-- search begin -->
					<div class="col-md-12 br5 p10 mb45 bgee" style="display:none !important;">
						<div style="text-align: center; display:inline-block;" class="searchBox_type2 mb10">
							<div class="selectBoxAr" style="width:140px;">
							...
							<div class="searchBoxAr">
								<input type="text" class="search-text" placeholder="검색어를 입력하세요" style="width:460px !important" id="keyword" onkeypress="if(event.keyCode==13)dateChk();"/>
					...
					<!-- 자원신청 현황 대시보드 -->
					<div class="pdApp_dashboard m-b-20">
						<div class="pdApp_dashboard_header">

							<p id="searchPeriod" ></p>
						</div>
<!-- 						<ul>
							<li class="li01">자원신청<br/><strong class="nanumR" id="newProductCnt"></strong><span>개</span></li>
							<li class="li02">자원변경<br><strong class="nanumR" id="changeProductCnt"></strong><span>개</span></li>
							<li class="li03">자원삭제<br><strong class="nanumR" id="exprProductCnt"></strong><span>개</span></li>
						</ul> -->


						<ul class="r_scd" >
							<li><p class="icon_bgc"><i class="fa fa-mouse-pointer"></i></p><h4>자원신청</h4> <h5 class="flex align-center mt10"><strong class="f18" id="newProductCnt">0</strong><span class="f16" style="margin-top:0;">개</span></h5></li>
							<li><p class="icon_bgc"><i class="fa fa-pencil-square-o"></i></p><h4>자원변경</h4> <h5 class="flex align-center mt10"><strong class="f18" id="changeProductCnt">0</strong><span class="f16" style="margin-top:0;">개</span></h5></li>
							<li><p class="icon_bgc"><i class="fa fa-trash-o"></i></p><h4>자원삭제</h4> <h5 class="flex align-center mt10"><strong class="f18" id="exprProductCnt">0</strong><span class="f16" style="margin-top:0;">개</span></h5></li>
						</ul>

					</div>


					<div class="col-md-12 pr0 pl0 mt20">
					<div class="searchBoxArea width-150 dpin flr mb10">
					     <label class="selectBoxDrop" for="">전체</label>
						  <select class="search-sel" name="productAt"  id="productAt" onchange="gridList();">
						    <option value="searchAll">전체</option>
						    <option value="APPRV_WAITING">진행중</option>
						    <option value="APPRV_REJECTED">반려</option>
						    <option value="APPRV_COMPLETED">처리완료</option>
						  </select>
					</div>
					</div>
					<div class="card_contents_wrap board_pdApp mt20" id="cardList">
					<!-- // card_list_row -->
					</div>
		...
		<script type="text/javascript">
			...
			function gridList() {
				...
				$("#mbrProjectOkList").dataTable( {
					...
					,"serverSide":true
					,"ajax": {
						"url":"${wasPath}/mbr/req/catalogue/bssOrderStatusList"
						,"type" : "GET"
						,"dateSrc" : ""
						,"data":function (d) {
							d.userId = "${userId}";
							d.productAt = $("#productAt").val();
			...
			function setCardList(jsonData){
				...
				for(var i=0; i<jsonData.data.length; i++){
					...
					Html +=			"<a href='${wasPath}/mbr/req/catalogue/bssOrderView?orderNo="+orderNo+"'>";
					//Html +=				"<li class='p_code nanumR'>"+orderNo+"</li>";
...
/*
	if(amount == undefined){ amount = "0"; }
					...
					if(apprvState =='APPRV_WAITING'){
		    			...
		    			//Html +=				"<span class='db center f14 fb tac pt10'>작성중</span>";
...
//					Html +=				"<li class='name'>"+orderUserDeptName+" <span>("+orderUserName+")</span></li>";
					...
					Html +=				"<li class='date'><span class='date_text'>"+orderDatetime +"</span></li>";
					Html +=			"</a>";
	//				Html +=			"<span class='color_btm'></span>";
			...
			function getStatusCnt(){
				...
				$.ajax({
					url : "${wasPath}/mbr/req/catalogue/bssOrderStatusCnt",
					dataType : "JSON",
					data : {
						"userId" : "${userId}"
