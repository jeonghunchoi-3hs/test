...
public class BssAdjustmentExcelView extends AbstractXlsView{
	...
	protected void buildExcelDocument(Map<String, Object> modelMap, Workbook workbook, HttpServletRequest req,
		...
		if(excelGbn.equals("bssAdjustment")){
			bssAdjustmentExcel(workbook, (List<CustomBssAdjustmentVO>) modelMap.get("excel_list"), excelTitle);
		}
		res.setContentType("Application/Msexcel");
	}
	
	private void bssAdjustmentExcel(Workbook workbook, List<CustomBssAdjustmentVO> list, String excelTitle) {
