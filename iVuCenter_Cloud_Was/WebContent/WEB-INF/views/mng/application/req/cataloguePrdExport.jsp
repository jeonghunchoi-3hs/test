	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>운영 배포</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">어플리케이션</a><a href="#" class="on">운영배포</a>
				</div>
			</div>
...
<!-- 							<input type="hidden" id="h_envGroupId"	value="" /> -->
...
<!-- 												</div> -->
						...
						<!-- 버튼박스 시작 -->
						<div class="btn_area">
<!-- 							<a type="button" class="pbton bton_blue"  onclick="openApproveReviewModal();">배포 신청</a> -->
							<a type="button" class="pbton bton_dgrey ml10" onclick="moveListPage();">목록</a>
						</div>
						<!-- 버튼박스 끝 -->
					</div>
				</div>
...
// 		}
	...
	function moveListPage() {
		location.href="${wasPath}/mng/application/env/prodList"
	}
