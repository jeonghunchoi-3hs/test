...
<!-- <body class="boxed-layout">  -->
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<p class="page_title">가상서버 신청
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 자원신청  <span class="arrow_ab"> &#8227; </span> <b>가상서버 신청 </b>
			    </span>
			</p>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		alertBox3("가상서버 신청 관련 문의사항은 <br> 사용문의 -> Q&A 게시판에 등록 바랍니다.");
		...
		$.ajax({
			...
			success : function(req) {
				...
				$.each(vmList,function(key,val){
					...
					if(val["imageType"] != "APPIMGDEV110"){// Container Terminal 제외
						var Html="";

						Html="<tr>";
						Html+="<td class='tac vm'><img src='"+val["imagePath"]+"'  class='height-80'></td>";
						...
						Html+="<td class='BasketArea'><a href='${wasPath}/mbr/req/catalogue/catalogueOrder.do?productSeq="+val["productSeq"]+"&hourlyFlag=N&cloudId="+val["cloudId"]+"&instanceType="+ instanceType +"' class='insertBasket'></a></td>";
