...
public class UpdateBillChargeVmResourceForAmountWriter implements ItemWriter<BatchBillChargeResourceVO> {

	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String updateBillChargeVmResourceForAmount = batchBillingDAO + "updateBillChargeVmResourceForAmount";
...
//        this.baseBillEndDate = (Date) this.parameterValues.get("baseBillEndDate");
        ...
        for (BatchBillChargeResourceVO item : items) {
        	this.sqlSessionTemplate.update(updateBillChargeVmResourceForAmount, item);
        }
