...
<script type="text/javascript">
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"columns":[
				...
				, {"data":"networkId" , "class":"tal overflow-path"}
				, {"data":"networkName" , "class":"tal name"}
				, {"data":"networkAlias" , "class":"tal"}
				, {"data":"subnetName" , "class":"tal"}
				, {"data":"subnetCidr" , "class":"tal"}
				, {"data":"portCnt" , "class":"tar"}
				, {"data":"" , "class":"tac"}
			]
			,"columnDefs":[
	...
	function moveDetailPage(noticeNo){
		location.href = "${contextPath}/mng/oss/network/detail?networkId="+noticeNo;
 	}
	...
	function excelDown(){
		...
		location.href = '${contextPath}/mng/oss/network/excel?'+params;
	}
