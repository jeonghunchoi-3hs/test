...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer in">
		...
		<!-- begin #content -->
		<form name="catalogueform"  id="catalogueform" action="cataloguePrd" method="post" >
				 ...
				 <div class="row p20 bgwh br10">
					...
					<div class="orderArea">
						<div class="tableF">
							...
							<input type="hidden" id="h_projectBoxId"	value="${projectBoxId}"/>

							<input type="hidden" id="h_envId"	value="${prdPipeLine.cicdProjectId}" />
							<input type="hidden" id="h_envName"	value="${prdPipeLine.envName}" />
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<input maxlength="30" class="form-control parameterClass" name="projectAlias" id="projectAlias" value="${prdPipeLine.projectAlias}" type="hidden"/>
...
<!-- 												<img src="/resources/assets/img/icon_search.png" onclick="openEnvModal();" class="input_search t10 r0"/> -->
											...
											<td>
												...
												<input type="text" maxlength="30" class="form-control  parameterClass" name="imageProductName" id="imageProductName"  value="${prdPipeLine.imageProductName}" readonly/>
...
<!-- 												</div> -->
										...
										<tr>
											...
											<td>
												<input class="form-control parameterClass" type="text" name="domainUrl" id="domainUrl" value=""/>
											</td>

											<td>
												<select class="form-control" name="domain" id="domain" >
														<option value="">선택</option>
														<c:forEach items="${getDomainUrlTypeCode}" var="getDomainUrlTypeCode">
																<option value="${getDomainUrlTypeCode.codeId}" >${getDomainUrlTypeCode.codeName}</option>
														</c:forEach>
												</select>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
						                    	<input maxlength="30" class="form-control parameterClass" name="appAlias" id="appAlias" type="text" value="${prdPipeLine.appAlias}"/>
											</td>
										...
										<tr>
											...
											<td id="DisplaydiskCnt">
												<div class="flex align-center">
													<input class="form-control w138" type="text"  placeholder="1" value="${prdPipeLine.podCnt}" maxlength="5" name="podCount" id="podCount" onkeypress="number_only(this);" onkeyup="number_only(this);" onblur="number_only(this);" style="ime-mode:disabled;" /> <p class="inputUnit"> 개 </p>
...
<!-- 												</div> -->
						                	...
						                	<td colspan="4">
						                		<ul class="pipeline-group">
						                			...
						                			<li>
						                				...
						                				<div class="pip-content">
						                					<div class="pip-status">Deploy-job <i class="before"></i></div>
						                				</div>
						                			</li>
						                			<li>
						                				<div class="title">운영</div>
						                				<div class="pip-content">
						                					<div class="pip-status">Prd-depoly-job <i class="before"></i></div>
						                				</div>
						                			</li>
						                		</ul>
						                	</td>
						...
						<!-- 버튼박스 시작 -->
						<div class="btn_area">
							<a type="button" class="btn_navy"  onclick="openApproveReviewModal();">배포 신청</a>
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td colspan="3"><span class="cnt nanumR" id="pop_cloudName"></span></td>
												</tr>
												<tr>
...
// 						Html="<tr><td class='tac'>"+val["projectName"]+"</td>";
	...
	function okProjectInsert(){
   	...
   	function openApproveReviewModal(){
		...
		if($("#domainUrl").val()==""){
			alertBox3("도메인 주소를 입력하세요");
			return false;
		}
		if($("#domain > option:selected").val()==""){
			alertBox3("도메인을 선택하세요");
			return false;
		}
...
// 		}
	...
	function moveListPage() {
		location.href="${wasPath}/mbr/application/env/"
	}
