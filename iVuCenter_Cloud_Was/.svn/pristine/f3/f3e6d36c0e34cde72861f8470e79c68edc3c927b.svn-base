...
@Slf4j
@Controller
@RequestMapping(value="/mng/oss/vm")
public class MngOssVmController{

    private static final Logger logger = LoggerFactory.getLogger(MngOssVmController.class);

	@Autowired
	private CmmUserService cmmUserService;

	@Autowired
	private OssVmService service;

	@Autowired
	private OssCloudService ossCloudService;

	@RequestMapping(value="/list", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	public ResponseEntity<String> MngOssVmList(CustomOssVmVO req , ModelMap model) {
	...
	public ResponseEntity<String> OsscatalogueVmList(CustomOssVmVO req) {
	...
	public ResponseEntity<CustomOssVmVO> MngOssVmDetail(CustomOssVmVO req) {
	...
	public ResponseEntity<String> MngOssVmUpdate(CustomOssVmVO req, Principal principal) {
		String res = "";
		try {
	...
	public ResponseEntity<String> MngOssVmAction(CustomOssVmVO req) throws Exception {
	...
	public ModelAndView MngOssVmExcel(CustomOssVmVO req, ModelMap map) {
		map.addAttribute("excel_gbn", "projectVm");
