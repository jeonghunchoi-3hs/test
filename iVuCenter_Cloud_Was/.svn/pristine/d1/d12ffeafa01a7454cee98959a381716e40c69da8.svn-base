...
import com.ivucenter.cloud.batch.entity.BatchBillChargeServiceVO;

import lombok.Setter;

public class UpdateBillChargeServiceForAmountWriter implements ItemWriter<BatchBillChargeServiceVO> {

	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String updateAmountForBillChargeService 	= batchBillingDAO + "updateAmountForBillChargeService";
...
//    private Date baseBillEndDate;
	...
	@Override
	public void write(List<? extends BatchBillChargeServiceVO> items) throws Exception {
...
//        this.baseBillEndDate = (Date) this.parameterValues.get("baseBillEndDate");
        ...
        for (BatchBillChargeServiceVO item : items) {
        	this.sqlSessionTemplate.update(updateAmountForBillChargeService, item);
        }		
	}
