	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<p class="page_title">블록디스크
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 자원현황  <span class="arrow_ab"> &#8227; </span> <b><a href="${wasPath}/mbr/project/disk/">블록디스크 </a> </b>
			    </span>
				</p>
			...
			function gridList() {
				$("#table-list-disk").dataTable( {
					...
					,"ajax": {
						...
						,"type" : "GET"
						,"data":function (d) {
							console.log(d.managerId);
							console.log(d.projectManagerId);
					...
					,"columns":[
						...
						, {"data":"diskCnt" , "class":"tac","render":function (data,type,full,meta){
			...
			//	tblColorSet();
				...
				//	}
					function movePageDetail(projectBoxId, projectName, programSeq){
						...
						location.href = "${contextPath}/mbr/project/disk/view"+params;
					}
