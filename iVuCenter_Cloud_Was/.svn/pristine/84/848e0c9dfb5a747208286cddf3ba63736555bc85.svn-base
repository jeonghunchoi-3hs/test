...
public class InsertBillChargeDiskResourceDetailProcessor implements ItemProcessor<BatchBillChargeResourceVO, List<BatchBillChargeResourceDetailVO>> {	

	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String selectListMeteringMeasureDisk 	= batchBillingDAO + "selectListMeteringMeasureDisk";
...
//        this.baseBillEndDate = (Date) this.parameterValues.get("baseBillEndDate");
        ...
        /* 미터링 정보 수집 */
		List<BatchMeteringMeasureVO> measures = this.sqlSessionTemplate.selectList(selectListMeteringMeasureDisk, item);
