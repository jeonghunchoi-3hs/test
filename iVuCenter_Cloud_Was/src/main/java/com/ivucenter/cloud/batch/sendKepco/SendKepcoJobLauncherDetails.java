...
public class SendKepcoJobLauncherDetails extends QuartzJobBean{
    
    private static final String SPRING_BATCH_JOB_NAME = "sendKepcoJob";
     
    @Override
    protected void executeInternal(JobExecutionContext context){
        
    	log.debug("---------------------SendKepcoJobLauncherDetails------------------------"); 
