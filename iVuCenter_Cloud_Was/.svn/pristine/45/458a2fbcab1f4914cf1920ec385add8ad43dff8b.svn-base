		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<div class="page_header mb30">
					<h1>PV</h1>
					<div class="pageNav">
						<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">PV</a>
					</div>
				</div>
				<!-- end header -->
				...
				<div class="row pb50">
						...
						<div class="searchArea">
							<div class="selectBox">
								...
								<select type="select" class="search-sel width-150" id="searchKind" title="전체">
									...
									<option value="project_id">프로젝트ID</option>
									<option value="project_alias">프로젝트명</option>
									<option value="nas_name">NAS명</option>
								</select>
							</div>
					...
					<div class="usageStatusWrap mb20">
						...
						<dl>
						    <dt>총 합계</dt>
							<dd><span class="title"><i class="fa fa-circle f12 fc-green mr10"></i>NAS</span><span class="cnt" id='title_totalNasSize'><em class="fc-green">0</em>GB</span></dd>
		...
		<script type="text/javascript">
			...
			function gridList(act) {
				...
				$("#table-list").dataTable({
					...
					,"destroy" : true
					,"ajax": {
						"url":"${contextPath}/mng/productUsageStatus/pv/list"
						,"type" : "GET"
						,"data":function (d) {
					...
					,"initComplete" : function(setting, json){
						 $("#title_totalNasSize em").text(json.totalSize);
					...
					,"columns":[
							...
							, {"data":"nasName", "class":"tac overflow-path"}
							, {"data":"nasGb"}
							, {"data":"regDatetime"}
					]
					,"columnDefs":[
			...
			function excelDown(){
				...
				location.href =  '${contextPath}/mng/productUsageStatus/pv/excel?'+encodeURI(params);
			}
			...
			$(document).ready(function() {
				...
				$("#productUsageStatusPv").addClass("active");
