		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<div class="page_header mb30">
					<h1>이벤트 발생 현황</h1>
					<div class="pageNav">
						<a href="#" class="home"><i></i></a><a href="#">모니터링</a><a href="#" class="on">이벤트 발생 현황</a>
					</div>
				</div>
				<!-- end header -->
					...
					<div class="page_searchBox">
						<div class="searchArea">
							<div class="selectBox">
								...
								<input type="text" placeholder="검색어를 입력하세요" id="keyword" onkeypress="if(event.keyCode==13)loadData();" class="width-600 ml5">
								<a type="button" class="bton-s bton_blue" onclick="loadData()"> <i class="fa fa-search"></i>  검색</a>
						</div>
					</div>
                    ...
                    <div class="wrap">
                        <div class="mb30">
                            <div class="mt-3 col-md-12">
                                <ul class="event-status-list-wrap" id="eventAt">
