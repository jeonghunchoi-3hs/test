...
@Slf4j
public class ProvisioningContextTasklet implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        this.provisioningStatus =  "PROVISIONING_ONGOING";
        this.provisioningSeq 		= (String) this.parameterValues.get("provisioningSeq");
        
		log.debug("applyDatetime=" + applyDatetime+", provisioningStatus="+provisioningStatus + ", provisioningSeq" + provisioningSeq );
