			 ...
			 <div class="row mb50">
				<div class="client_DetailBg">
					<div class="client_DetailArea">
						...
						<h2 class="customer_Id">05003</h2>
						<div class="comp_btn_Area">
							<sec:authorize access="hasRole('ROLE_CLOUD_ADMIN')">
		                     	<a type="button" class="btnType02" onclick="moveInsertPage();" id="noticeList"><span class="txt"><i class="ico_edit"></i>정보수정</span></a> 
							</sec:authorize>
						</div>
						<p class="company_Name2" id="">양곡도매몰 프로젝트</p>
						<p class="company_Info">
							<span class="company_labelf">본사 :</span><span class="company_cont" id="">쓰리에이치에스</span>
							<span class="company_label">고객사 :</span><span class="company_cont" id="">솔루션사업부</span>
							<span class="company_label">시작일 :</span><span class="company_cont fontVdn" id="">2017-09-18</span>
							<span class="company_label">종료일 :</span><span class="company_cont fontVdn" id="">2017-09-18</span>
							<span class='state_use'>사용</span>
						</p>
						<p class="project_acc">기본정보 상세의 설명내용 영역 입니다. 기본정보 상세의 설명내용 영역 입니다.</br>
												기본정보 상세의 설명내용 영역 입니다.기본정보 상세의 설명내용 영역 입니다.기본정보 상세의 설명내용 영역 입니다.기본정보 상세의설명내용 영역 입니다.</p>
						
						<ul>
							<li class="manager_Info2">
								<h2>관리자정보</h2>
								<div class="mt15"> 
									<span class="manager_Name" id="">홍길동</span>
									<span class="manager_Id_label">(ID : <span class="manager_Id" id="">94106367</span>)</span>
									<input type="hidden" name="managerName" id="" value=""/>
								</div>
								<div class="mt13"> 
									<span class="manager_Tel" id="">02-2222-2222</span>
									<span class="manager_Phone" id="">010-1234-5678</span>
									</br><span class="manager_Mail" id="">user01@nongbhyup.com</span> 
								</div>
							</li>
							<li class="manager_Info2 dashedline"> 
								<h2>담당PM정보</h2>
								<div class="mt15"> 
									<span class="manager_Name" id="">홍길동</span>
									<span class="manager_Id_label">(ID : <span class="manager_Id" id="">94106367</span>)</span>
