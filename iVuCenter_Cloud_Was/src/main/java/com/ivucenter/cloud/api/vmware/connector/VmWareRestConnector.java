package com.ivucenter.cloud.api.vmware.connector;
...
@Slf4j
public class VmWareRestConnector {

    private static final Logger logger = LoggerFactory.getLogger(VmWareRestConnector.class);
	...
	public static VmRestResponse doRequest(HttpMethod method, String url, Map<String, String> headers, String contentType)
	...
	public static VmRestResponse doRequest(HttpMethod method, String url, Map<String, String> headers, String contentType,String payLoad)
			throws NotConnectGatewayException, NotSupportGatewayException, InvaildOpenStackException {
				return doRequest(method, url, headers, contentType, payLoad, false,"");
			}
	public static VmRestResponse doRequest(HttpMethod method, String url, Map<String, String> headers, String contentType,String payLoad, String authString)
			throws NotConnectGatewayException, NotSupportGatewayException, InvaildOpenStackException {
				return doRequest(method, url, headers, contentType, payLoad, false, authString);
			}
	public static VmRestResponse doRequest(HttpMethod method, String url, Map<String, String> headers, String contentType, String payLoad, boolean isNoHttpResponse, String authString)
			throws NotConnectGatewayException, NotSupportGatewayException, InvaildOpenStackException {
		VmRestResponse output = null;
	...
	private static VmRestResponse responseHandler(HttpResponse response) throws IOException {
		VmRestResponse output = new VmRestResponse();
		if(null != response) {
			// body
