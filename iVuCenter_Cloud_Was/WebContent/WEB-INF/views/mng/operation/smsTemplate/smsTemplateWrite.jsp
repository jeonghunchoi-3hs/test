...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			<!-- begin page-header -->
			<h1 class="page-header fc66"> <i class="fa fa-dot-circle-o fcb"> </i> SMS템플릿 수정 <span class="root">관리자포털 > SMS > SMS템플릿 </span></h1>
			<!-- end page-header -->
								...
								<tbody>
									...
									<tr>
										<td class="cen height-40 tal">메시지</td>
									  	<td colspan="3">
										 	<div class="col-md-6">
										  		<textarea class="form-control" rows="7" id="message" placeholder="내용을 입력하세요" ></textarea>
										  </div>
									  	</td>									  	
									</tr> 
									<!-- <tr>
...
<script type="text/javascript">
	...
	function actInsert() {
		$.ajax({
			url : "${contextPath}/mng/sms/template/update",
			dataType : "JSON",
			type : "POST",
			data : {
				"templateId" : $("#templateId").val()
