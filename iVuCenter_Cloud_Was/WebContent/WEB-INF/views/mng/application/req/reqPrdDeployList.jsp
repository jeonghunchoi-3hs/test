	...
	<div id="page-container"
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>배포 현황(운영)</h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">배포 현황(운영)</a>
				</div>
			</div>
...
// 						, {	"data" : "envApplicationVersion"}
		...
		function movePageDetail(cicdProjectId, pipelineId, orderProductSeq, projectBoxId, appName) {
			...
			location.href = "${contextPath}/mng/application/req/cataloguePrdExportDetail"+ params;
		}
