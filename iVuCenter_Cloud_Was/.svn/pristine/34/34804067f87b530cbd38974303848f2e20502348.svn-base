	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1> 로드밸런서 </h1>
				<div class="pageNav">
					<a href="${contextPath}/mng/login/main" class="home"><i></i></a><a href="#">프로젝트</a><a href="#" class="on">로드밸런서 관리</a>
				</div>
			</div>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function gridList() {
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/oss/loadbalancer/list"
				,"type" : "GET"
				,"data":function (d) {
			...
			,"columns":[
				...
				, {"data":"managerTel"}
				, {"data":"managerPhone"}				
				, {"data":"loadbalancerEa" , "class":"tar","render":function (data,type,full,meta){
	...
	function movePageDetail(projectId, projectName, programSeq){
		...
		location.href = "${contextPath}/mng/project/lb/view"+params;
	}
