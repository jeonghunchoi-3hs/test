...
public class SyncOpenStackAvailReader implements ItemReader<CustomOssCloudVO> {
	...
	private List<CustomOssCloudVO> openStackUsage = null;

	@Autowired
	private OssCloudService ossCloudService;

	@Override
	public CustomOssCloudVO read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
	...
	public void initialize() throws Exception {
		...
		for (CustomOssCloudVO cloudVo : lists) {
				...
				this.openStackUsage.add(cloudVo);
