package com.ivucenter.cloud.portal.mnginfo;
...
@Slf4j
@Controller
@RequestMapping(value="/mng/mnginfo")
public class MngInfoSearchController {
...
//	@Autowired	private AlarmsTemplateService alarmsTemplateService;
	...
	public ResponseEntity<String> mngUseridSearch(CustomCmmUserVO req){
...
//		getUserInfo.setUserMail(getUserInfo.getUserMailDec());
	...
	public ResponseEntity<String> mngUserpwSearch(CustomCmmUserVO req) {
	...
	public ResponseEntity<String> customerpwSearch(CustomCmmCustomerVO req){
		...
		if(getUserInfo==null){
			...
			req.setTemplateId(CodeUtil.MAL0042);			
