...
public class InsertBillChargeServiceWriter implements ItemWriter<BatchBillChargeServiceVO> {

	private final String batchBillingDAO = "com.ivucenter.cloud.batch.billing.BatchBillingDAO.";
	
	private final String insertBillChargeService 	= batchBillingDAO + "insertBillChargeService";
...
//        this.billYM = (String) this.parameterValues.get("billYM");
        ...
        for (BatchBillChargeServiceVO item : items) {
        	...
        	this.sqlSessionTemplate.insert(insertBillChargeService, item);
        }		
	}
}
