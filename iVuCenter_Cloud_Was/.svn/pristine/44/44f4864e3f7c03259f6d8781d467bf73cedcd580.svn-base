...
@Slf4j
@Controller
@RequestMapping(value="/mbr/oss/service")
public class MbrOssServiceController{
	...
	@RequestMapping(value="/mbrServiceDetail", method = RequestMethod.GET, produces="text/plain;charset=UTF-8")
	public ResponseEntity<String> mbrProjectServiceDetail(CustomOssServiceVO req , ModelMap model) {
		String res = service.mbrServiceDetail(req);
		return new ResponseEntity<String>(res, HttpStatus.OK);
	}	
	...
	@RequestMapping(value = "/mbrServiceDetailInfo")
	public ResponseEntity<CustomOssServiceVO> MngServiceDetailInfo(CustomOssServiceVO req) {
		CustomOssServiceVO res = service.mbrServiceDetailInfo(req);
		return new ResponseEntity<CustomOssServiceVO>(res, HttpStatus.OK);
	}
	...
	public ModelAndView MbrOssserviceViewExcel(CustomOssServiceVO req, ModelMap map) {
	...
	public ResponseEntity<Object> getServiceList(CustomOssServiceVO req){
		...
		List<CustomOssServiceVO> getServiceList = service.getServiceList(req);
