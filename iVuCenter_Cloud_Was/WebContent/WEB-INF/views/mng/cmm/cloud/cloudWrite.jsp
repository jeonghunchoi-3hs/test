						...
						<table class="tableH">
							...
							<tbody>
								...
								<tr>
									...
									<td><input maxlength="30" type="text"  autocomplete="new-password" class="w100" name="calmAdminUser" id="calmAdminUser"></td>
									<th>calm_admin_password</th>
									<td><input maxlength="30" type="password" autocomplete="new-password" class="w100" name="calmAdminPassword" id="calmAdminPassword"></td>
								</tr>
								...
								<tr>
									...
									<td><input maxlength="30" type="password" autocomplete="off" class="w100" name="adminPassword" id="adminPassword"></td>
								</tr>
								...
								<tr>
									...
									<td><input maxlength="60" type="password" autocomplete="off" class="w100" name="projectPassword" id="projectPassword"></td>
