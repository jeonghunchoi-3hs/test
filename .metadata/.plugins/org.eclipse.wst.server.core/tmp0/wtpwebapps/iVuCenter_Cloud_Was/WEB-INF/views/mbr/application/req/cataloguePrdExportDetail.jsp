...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer in">
		...
		<!-- begin #content -->
		<form name="catalogueform"  id="catalogueform" action="reqProdRedeployment" method="post" >
		...
		<div id="content" class="content">
			 	...
			 	<p class="page_title">
					...
					<span class="root f14">
						...
						<span class="text arrow">어플리케이션</span><span class="arrow_ab"> ‣ </span>
						<span class="text arrow mint"><strong>운영배포</strong></span>
					</span>
				</p>
				 <div class="row p20 bgwh br10">
					...
					<div class="orderArea">
						<div class="tableF">
							...
							<input type="hidden" name="cicdProjectId" id="cicdProjectId" value="${prdPipeLine.cicdProjectId}"/>
							...
							<input type="hidden" name="cpuReq" id="cpuReq" value="${prdPipeLine.cpuReq}"/>
							<input type="hidden" name="cpuLimit" id="cpuLimit" value="${prdPipeLine.cpuLimit}" />
							<input type="hidden" name="memReq" id="memReq" value="${prdPipeLine.memReq}" />
							<input type="hidden" name="memLimit" id="memLimit" value="${prdPipeLine.memLimit}" />
							<input type="hidden" name="osProductSeq" id="osProductSeq" value="${prdPipeLine.osProductSeq}"/>
							<input type="hidden" name="amount" id="amount" value="" />
							<input type="hidden" name="exportType" id="exportType" value="PROD"/>
							<input type="hidden" name="envType" id="envType" value="PROD"/>
							...
							<input type="hidden" name="h_cicdProjectId" id="h_cicdProjectId" value="${prdPipeLine.cicdProjectId}"/>
							<input type="hidden" namd="h_envId" id="h_envId"	value="${prdPipeLine.cicdProjectId}" />
							<input type="hidden" name="beforeOrderProductSeq" id="beforeOrderProductSeq"	value="${prdPipeLine.beforeOrderProductSeq}" />

							<input type="hidden" name="h_envApplicationVersion" id="h_envApplicationVersion"	value="${prdPipeLine.envApplicationVersion}" />
							<input type="hidden" name="h_envGroupId" id="h_envGroupId"	value="${prdPipeLine.groupId}" />
							<input type="hidden" name="h_flavorId" id="h_flavorId"	value="${prdPipeLine.flavorId}" />
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control parameterClass" name="cloudName" id="cloudName" value="${prdPipeLine.cloudName}" readonly/>
											...
											<td>
												<input maxlength="30" class="form-control parameterClass" name="projectName" id="projectName" value="${prdPipeLine.projectName}" type="text" readonly/>
												<input type="hidden" name="projectId" id="projectId" value="${prdPipeLine.prodProjectId}"/>
											</td>
										</tr>
										<tr>
											<td class="left">개발환경</td>
											<td>
												<input class="form-control parameterClass" type="text" name="envName" id="envName" value="${prdPipeLine.envName}" readonly/>
												<input class="form-control parameterClass" type="hidden" name="envAlias" id="envAlias" value="${prdPipeLine.envAlias}" readonly/>
<!-- 												<img src="/resources/assets/img/icon_search.png" onclick="openEnvModal();" class="input_search t10 r0"/> -->
											</td>
											<td class="left">버전</td>
											<td>
												<input type="hidden" name="imageId" id="imageId"  value="${prdPipeLine.imageId}" readonly/>
												<input type="text" maxlength="30" class="form-control width-500 parameterClass" name="imageProductName" id="imageProductName"  value="${prdPipeLine.imageProductName}" readonly/>
...
<!-- 												</div> -->
										...
										<tr>
											...
											<td>
												<input maxlength="30" class="form-control parameterClass" name="envVisibilityLevel" id="envVisibilityLevel" value="${prdPipeLine.visibility}" type="text" readonly/>
											</td>
											<td class="left">도메인 주소</td>
											<td>
												<input class="form-control parameterClass" type="text" name="domainUrl" id="domainUrl" value="${prdPipeLine.domainUrl}" readonly/>
											</td>
										</tr>
										<tr>
											<td class="left" >git URL 주소</td>
											<td colspan="3">
												<input class="form-control parameterClass formInfo" type="text" name="gitRepository" id="gitRepository" value="${prdPipeLine.gitRepository}.git" readonly/>
											</td>
										</tr>
										<tr>
											<td class="left">어플리케이션 명</td>
											<td>
						                    	<input maxlength="30" class="form-control parameterClass" name="appAlias" id="appAlias" type="text" value="${prdPipeLine.appAlias}" readonly/>
											</td>
											<td class="left">어플리케이션 ID</td>
											<td>
												<input maxlength="30" class="form-control parameterClass" name="appName" id="appName" type="text" value="${prdPipeLine.appName}" readonly/>
						                    </td>
										</tr>
										<tr>
											...
											<td>
						                        <div class="depth-dropdown-box">
													<div class="searchBoxArea">
														...
														<select class="search-sel form-select" name="appVerSpacGroup" id="appVerSpacGroup" disabled>
															<option value="">서버분류</option>
														</select>
													</div>
													<div class="searchBoxArea">
														<label class="selectBoxDrop" for="appFlavorId">컨테이너사양 선택</label>
														<select class="search-sel form-select" name="appFlavorId" id="appFlavorId" onchange="selectAppSpecGroup(${idNum});" disabled>
											...
											<td id="DisplaydiskCnt">
												<div class="flex align-center">
													<input class="form-control w138" type="text"  placeholder="1" value="${prdPipeLine.podCnt}" maxlength="5" name="podCount" id="podCount" onkeypress="number_only(this);" onkeyup="number_only(this);" onblur="number_only(this);" style="ime-mode:disabled;" readonly/> <p class="inputUnit"> 개 </p>
										...
										<tr>
											...
											<td>
												<div class="duplicate-check-box">
						                    		<input maxlength="30" class="form-control" name="deploymentPort" id="deploymentPort" type="text" value="${prdPipeLine.deploymentPort}">
						                    		<button type="button" onclick="appPortCheck();">중복체크</button>
					                    		</div>
											</td> --%>
											<td class="left" >Context Dir</td>
											<td class="multiple-items two-input-box" >
												<input maxlength="30" class="form-control" name="deploysDirectory" id="deploysDirectory" type="text" value="${prdPipeLine.deploysDirectory}" readonly />
						                	...
						                	<td colspan="4">
						                		...
						                		<ul class="pipeline-group">
						                			<li>
						                				...
						                				<div class="pip-content">
							                				<c:if test="${prdPipeLine.deployStatus eq 'SYNC_APP_SUCCESS'}">
								                				<div class="pip-status">skipped_production <i class="success"></i></div>
							                				</c:if>
							                				<c:if test="${prdPipeLine.deployStatus eq 'SYNC_APP_FAIL'}">
								                				<div class="pip-status">skipped_production <i class="fail"></i></div>
							                				</c:if>
							                				<c:if test="${prdPipeLine.deployStatus eq null}">
						                			...
						                			<li>
						                				...
						                				<div class="pip-content">
							                				<c:if test="${prdPipeLine.copyStatus eq 'SYNC_APP_SKIP'}">
								                				<div class="pip-status">skipped_production <i class="success"></i></div>
							                				</c:if>
							                				<c:if test="${prdPipeLine.copyStatus ne 'SYNC_APP_SKIP'}">
								                				<div class="pip-status">skipped_production <i class="before"></i></div>
							                				</c:if>
						                				</div>
						                			</li>
						                			<li>
						                				...
						                				<div class="pip-content">
							                				<c:if test="${prdPipeLine.productionStatus eq 'SYNC_APP_SUCCESS'}">
								                				<div class="pip-status">deploy_production <i class="success"></i></div>
							                				</c:if>
							                				<c:if test="${prdPipeLine.productionStatus eq 'SYNC_APP_FAIL'}">
								                				<div class="pip-status">deploy_production <i class="fail"></i></div>
							                				</c:if>
							                				<c:if test="${prdPipeLine.productionStatus eq null}">
...
<!-- 							<a type="button" class="bbton bton_green ml10" onclick="basketorder();"><span class="dpin dd bton_dgreen ml-1"><i class="fa fa-cart-arrow-down"></i></span><span class="dpin ml16">일괄신청</span></a> -->
							<c:if test="${prdPipeLine.productionStatus ne 'SYNC_APP_SUCCESS' and afterVersion eq 'N'}">
								<a type="button" class="btn_navy"  onclick="openApproveReviewModal();">재배포신청</a>
							</c:if>
										...
										<table>
											...
											<tbody>
												<tr>
													...
													<td><span class="cnt nanumR" id="pop_cloudName"></span></td>
												</tr>
												<tr>
													<th class="tal">어플리케이션 별칭</td>
													<td colspan="3"><span class="cnt" id="pop_appNameAlias"></span></td>
												</tr>
												<tr>
													<th class="tal">Git URL 주소</td>
													<td colspan="3"><span class="cnt" id="pop_gitRepository"></span></td>
												</tr>
												<tr>
													<th class="tal">이미지 버전</td>
													<td><span class="cnt" id="pop_appProductContainer"></span></td>
													<th class="tal">CPU</td>
													<td><span class="cnt" id="pop_podCpu"></span></td>
												</tr>
												<tr>
													<th class="tal">MEMORY</td>
													<td><span class="cnt" id="pop_podMem"></span></td>
													<th class="tal">POD 수</td>
													<td><span class="cnt" id="pop_podCnt"></span></td>
												</tr>
												<tr class="dpno">
													<th class="tal">금액<span class="fc-red">(VAT 별도)</span></th>
	                   ...
	                   <div class="modal-content width-720">
	                       ...
	                       <!--//검색 시작// 모달검색은 이걸 가져다 쓰면 됩니다. 2191217 nandakim-->
								...
								<!--검색  끝//-->
									...
									<div class="popEnvListTable"> <!-- 장과장님, popListTable 이 스크롤이 생기는 높이가 250px 인 div 에요.  5개씩 나오게 하고, 페이지가 생기게 할꺼면 이div 를 지우면 됩니다.  -->
										<table class="tableV">
											<colgroup>
												<col width="20%">
										 		<col width="*">
										 	...
										 	<thead>
									 		<tr class="skyblue">
									 			<th class="tac">개발환경 ID</th>
									 			<th class="tac">개발환경 명</th>
												<th class="tac">개발환경 경로</th>
												<th class="tac">적용</th>
											</tr>
									 	   </thead>
											<tbody id="popEnvListTable">
											</tbody>
										</table>
									</div>
...
// 		$("#pop_label").text($("#label").val());
	...
	function setOrder() {
		...
		$("#pop_appProductContainer").text($("#imageProductName").val());	// 카탈로그 상품 명
	...
	function moveListPage() {
		location.href="${wasPath}/mbr/application/req/reqPrdDeployList"
	}
