...
public class ResourcesDayJobLauncherDetails extends QuartzJobBean{
    
    private static final String SPRING_BATCH_JOB_NAME = "resourcesDayJob";
     
    @Override
    protected void executeInternal(JobExecutionContext context){
        
    	log.debug("---------------------ResourcesDayJobLauncherDetails------------------------"); 
