...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			<!-- begin header -->
			<h1 class="page-header fc66"> <i class="fa fa-dot-circle-o fcb"> </i> Nhwith 템플릿 목록 <span class="root">관리자포털 > NHwith > NHwith 템플릿 </span></h1>
			<!-- end header -->
...
<script type="text/javascript">
	...
	function movePageDetail(templateId){
		...
		location.href = "${contextPath}/mng/nhwith/template/templateView"+params
	}
 	
 	function moveInsertPage(){
 		location.href = "${contextPath}/mng/nhwith/template/write";
 	}
