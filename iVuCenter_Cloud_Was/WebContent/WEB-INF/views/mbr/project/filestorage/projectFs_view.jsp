	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<p class="page_title">파일스토리지 상세
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 자원현황  <span class="arrow_ab"> &#8227; </span> <a href="${wasPath}/mbr/project/disk/">PV 관리 </a>  <span class="arrow_ab"> &#8227; </span> <b>파일스토리지 상세</b>
			    </span>
				</p>
				...
				<div class="row p20 bgwh br10">
				  ...
				  <div class="col-md-12 pl0 pr0">
            	   ...
            	   <div class="col-md-12 pl0 pr0 mt20">
            	     ...
            	     <div class="col-md-12 pl0 pr0 mt20">
            	     <h4 class="f16 mb10 f500 mb20">현재 사용량 <a type="button" onclick="useAvailabilityDetail('${req.projectBoxId}');" class="btn_navy-ss flr"> 실시간 가용용량</a> </h4>
            	     <div class="col-md-6 sub_use_nas">볼륨<span class="flr"><em class="fc_orange_im f24 mr5" id='nasCnt'></em> EA</span> </div>
            	     <div class="col-md-6 sub_use_nas flr" style="margin-right:0;">NAS <span class="flr"><em class="fc_blue_im f24 mr5" id='nasGb'></em>GB</span></div>
            	     </div>
            	   </div>
			...
			<div class="modal fade" id="detail-modal-dialog">
			    <div class="modal-dialog">
			        <div class="modal-content w560">
			            ...
			            <div class="modal-footer tac">
			                <a type="button" class="btn btn-primary wid-75" href="${wasPath}/mbr/req/changeOrder/changeOrderView?viewFlag=Y">변경신청</a>
			                <a type="button" class="btn btn-outline-primary wid-75" data-dismiss="modal" id="popclose">닫기</a>
			            </div>
			        </div>
			    </div>
			</div>
	                       ...
	                       <div class="modal-body">
								...
								<div class="topArea txtAleft">
									...
									<p class="fl m-b-10">
										...
										<span class="hostName2 f18 fc11 fontVdn" id="modal_nasAlias"></span>
									</p>
									<p class="fl m-b-10">
										<span class="serverPopLabel">파일 경로</span>
										<span class="hostName2 f18 fc11 fontVdn" id="modal_nasFileSystemPath"></span>
									</p>
	                       		</div>

	                       		<div class="networkListWrap clearfix">
									<p class="m-b-10"><span class="serverPopLabel">어플리케이션명</span><span class="fixedNetwork2 p-l-5" id ="modal_appName"></span></p>
