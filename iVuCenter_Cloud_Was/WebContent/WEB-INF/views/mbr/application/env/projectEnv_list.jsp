...
<html lang="ko">
	...
	<body>
		...
		<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
			...
			<div id="content" class="content">
				...
				<span class="root f14">Home <span class="arrow_ab"> &#8227; </span><a href="${wasPath}/mbr/main"> 콘솔</a>  <span class="arrow_ab"> &#8227; </span> 자원현황  <span class="arrow_ab"> &#8227; </span> <b><a href="${wasPath}/mbr/application/env/envList">개발환경</a> </b>
			    </span>
				</p>
	...
	<script type="text/javascript">
				...
				function gridList() {
					$("#table-list-env").dataTable( {
						...
						,"columns":[
							...
							, {"data":"envCnt" , "class":"tac","render":function (data,type,full,meta){
						...
						,"columnDefs":[
							...
							, {"targets":[8], "render": function(data,type,full){
								return "<a href='javascript:void(0);' class='cbton bton_lblue'  onclick='movePageDetail(\""+full.projectBoxId+"\",\""+full.projectName+"\")'><i class='fa fa-search'></i></a>";
								}
							}
						]
						,"language": {
				...
				function movePageDetail(projectBoxId, projectName){
					var params = "?projectBoxId="+projectBoxId;
					params += "&projectName="+projectName;
					location.href = "${contextPath}/mbr/application/env/envView"+params;
				}
