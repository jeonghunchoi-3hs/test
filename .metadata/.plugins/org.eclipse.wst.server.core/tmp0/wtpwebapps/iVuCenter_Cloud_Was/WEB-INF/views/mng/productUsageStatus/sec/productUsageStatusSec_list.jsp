	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>보안관제 서비스</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">보안관제 서비스</a>
				</div>
			</div>
			<!-- end header -->
			...
			<div class="usageStatusWrap">
				...
				<div class="total" id="secTotal"><em>0</em>EA</div>
			</div>
			<!-- //Usage Status -->
			...
			<div class="gridTableWrap gridType03">
				...
				<div class="tableWrap m-t-15">
					...
					<!-- //상단 버튼  -->
					<table id="table-list" summary="보안관제 서비스"	> 
...
<script type="text/javascript">
	...
	function gridList(act) {
		...
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/productUsageStatus/sec/list"
				,"type" : "GET"
				,"data":function (d) {
			...
			,"initComplete" : function(setting, json){
				$("#secTotal em").text(json.recordsTotal);
			}
			,"columns":[ 
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/productUsageStatus/sec/excel?'+params;
	}
	...
	$(document).ready(function() {
		...
		$("#productUsageStatusSec").addClass("active");
	});
</script>
</body>
</html>