...
public class InsaUserSystemJobLauncherDetails extends QuartzJobBean {
	
	private static final String SPRING_BATCH_JOB_NAME = "InsaUserSystemJob";
	...
	protected void executeInternal(JobExecutionContext context) {
		...
		String standardDate = DateUtils.convertDateToString(new Date(), "Asia/Seoul", "yyyy-MM-dd HH:mm");
