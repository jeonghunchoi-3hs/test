	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="mbrCompArea">
		    	...
		    	<p class="f36 fc11 mt15">아이뷰센터 클라우드 사이트에</p>
				<p class="f36 fc11 lh8d">가입해주셔서 감사합니다.</p>
		    	<p class="f20 fc66 lh3d8">아이뷰센터 클라우드 웹사이트 회원으로 가입이 완료되었습니다</p>
		    </div> 
			    <!-- end section-container -->	   
				<!-- begin button----------->
			<div class="btn_area">	
				<a type='button' id="jquerybuttonok" name="jquerybuttonok"  class="bt_w298 bt_loginGo" onclick="moveLoginPage();">로그인화면으로 이동</a>
			</div> 
			<!-- end button-----------> 
