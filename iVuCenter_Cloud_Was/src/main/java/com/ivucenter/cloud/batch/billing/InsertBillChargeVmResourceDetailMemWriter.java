...
@Slf4j
public class InsertBillChargeVmResourceDetailMemWriter implements ItemWriter<List<BatchBillChargeResourceDetailVO>> {
	
	/* MEMORY RPRICE CODE */
	private final String ITEM_PRICE_CODE = "MEM010";
