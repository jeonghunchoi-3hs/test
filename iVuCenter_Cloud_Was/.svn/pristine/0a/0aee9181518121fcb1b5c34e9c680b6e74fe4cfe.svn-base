...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<div id="content" class="content">
			<!-- begin header -->
			<h1 class="page-header fc66 fb"> <i class="fa fa-dot-circle-o fcb"> </i> SMS 모니터링 <span class="root">관리자포털 > 모니터링 > SMS 모니터링</span></h1>
			<!-- end header -->
			...
			<div class="row mb50">
				...
				<div class="col-md-12">
					<div id="zenius01">
						<iframe class="w100" style="height: 650px;" src="http://10.220.211.200/zenius61/common/login.action?_m=loginLink&userid=testuser&pageUrl=/sms/smsMonitor.action?&pageParam=_m_eq_getMain_am_infraId_eq_10_am_infraName_eq_sms_am_zMenuGroup_eq_0_am_zMenuSub_eq_0"></iframe>					
					</div>
	...
	function moveDetailPage(hostname, hostnameAlias){
		location.href = "${contextPath}/mng/monitor/event/view?hostname="+hostname+"&hostnameAlias="+hostnameAlias;
	}
			...
			,"columnDefs":[
				{"defaultContent" : "", targets:"_all" }
 				, {"targets":[0], "render": function(data,type,full){
 					return "<a href='#' onclick='moveDetailPage(\""+full.hostname+"\",\""+full.hostnameAlias+"\")'>" + full.hostname + "</a>";
					}	
				}
	...
	function gridEventList() {
		$("#event-list").dataTable( { 
			...
			,"serverSide":true
			,"ajax": {
				"url":"${contextPath}/mng/monitor/event/list"
				,"type" : "GET"
				,"dateSrc" : ""
				,"data":function (d) {
					d.projectId = $("#projectId > option:selected").val();
