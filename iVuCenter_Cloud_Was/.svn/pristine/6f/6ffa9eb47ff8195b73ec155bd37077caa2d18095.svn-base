	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer in">
		...
		<div id="content" class="content">
			...
			<div class="page_header mb30">
				<h1>공인IP</h1>
				<div class="pageNav">
					<a href="#" class="home"><i></i></a><a href="#">자원사용현황</a><a href="#" class="on">공인IP</a>
				</div>
			</div>
			<!-- end header -->
			...
			<div class="usageStatusWrap">
				...
				<dl>
					<dt>총 합계</dt>
					<dd class="type_03 bgNone">&nbsp;</dd>
				</dl>
				<div class="total" id="ipTotal"><em>0</em>EA</div>
			</div>
			<!-- //Usage Status -->
			<!-- 테이블시작 -->
			<div class="gridTableWrap gridType03">
				...
				<div class="tableWrap m-t-15">
					...
					<!-- //상단 버튼  -->
					<table id="table-list" summary="공인IP"> 
						<caption>게시판 목록 : 구분, 고객사명, 프로젝트명,  과금단위, 삼품가입일시로 구성</caption> 
						<colgroup>
							<col width="127px">
							<col width="228px">
							<col width="294px">
...
<!-- 								<th scope="col" class="f16">연결대상</th> -->
...
<script type="text/javascript">
	...
	function gridList(act) {
		...
		$("#table-list").dataTable( {
			...
			,"destroy" : true
			,"ajax": {
				"url":"${contextPath}/mng/productUsageStatus/ip/list"
				,"type" : "GET"
				,"data":function (d) {
...
// 				, {"data":"connectionTarget" , "class":"tac"}
	...
	function excelDown(){
		...
		location.href =  '${contextPath}/mng/productUsageStatus/ip/excel?'+params;
	}
	...
	$(document).ready(function() {
		...
		$("#productUsageStatusIp").addClass("active");
	});
</script>
</body>
</html>