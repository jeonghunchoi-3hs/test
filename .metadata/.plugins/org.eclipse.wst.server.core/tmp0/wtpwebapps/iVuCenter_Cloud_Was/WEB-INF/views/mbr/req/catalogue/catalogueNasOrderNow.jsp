...
<body>
	...
	<div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-footer">
		...
		<!-- begin page-header -->
			<h1 class="page-header"> <img src="<%=request.getContextPath()%>/resources/images/title_icon/basket.png"/>  신청<span class="root"> <img src="/resources/assets/img/root_icon.png"/> 콘솔 > 자원신청 > 부가자원 > NAS </span></h1>
			<!-- end page-header -->
			...
			<div class="panel mb0">
				<div>
					...
					<input type="hidden" name="nasProductSeq" id="nasProductSeq" value="${ordervo.productSeq}" />
					...
					<input type="hidden" name="nasId" id="nasId" value="${ordervo.nasId}" />	
					<input type="hidden" name="requestType" id="requestType" value="${ordervo.requestType}" />
					<input type="hidden" name="beforeNasGb" id="beforeNasGb" value="${ordervo.beforeNasGb}" />			
					<input type="hidden" name="cloudId" id="cloudId" value="${ordervo.cloudId}" />			
					<input type="text" name="approvalStepListString" id="approvalStepListString" value="${ordervo.approvalStepListString}" />			
...
<!--                       <input type="button" onclick="moveVmPage();" value="취소"  class="btn btn-grey width-80"> -->
                        ...
                        <a href="javascript:;"><img src="/resources/assets/img/btn_order.png" onclick="valChk();"/></a><a href="javascript:;"><img src="/resources/assets/img/btn_cancel.png"  class="ml10" onclick="moveVmPage();"/></a>
			</div>	
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-body" id="confirmMsg">
                               ...
                               <p class="m-b-20 tac mt20">   
								 ...
								 <a href="javascript:;"  class="btn btn-grey width-80" data-dismiss="modal">취소</a>   
                               </p>
                           </div>
                       </div>
                   </div>
                   ...
                   <div class="modal-dialog">
                       <div class="modal-content">
                           ...
                           <div class="modal-body">
                               <h5>신청이 완료 되었습니다.</h5>
                               <p class="m-b-20 tac mt20">   
								 <a href="javascript:;"  class="btn btn-grey width-80" data-dismiss="modal" onclick="movePage();">확인</a>   
                               </p>
                           </div>
	...
	<script type="text/javascript">
		...
		function setJsonData(){
			...
			if(applyDatetime == ""){
				jsonData={
						"type" : $("#type").val()
						, "nasProductSeq" : $("#nasProductSeq").val()
						, "amount" : $("#amount").val()
						...
						, "description" : "${ordervo.description}"		
						, "vmName" : $("#vmName").val()
						, "vmUuid" : $("#vmUuid").val()
