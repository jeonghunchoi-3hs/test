...
public class ResourcesMonthJobLauncherDetails extends QuartzJobBean{    
    
    private static final String SPRING_BATCH_JOB_NAME = "resourcesMonthJob";
     
    @Override
    protected void executeInternal(JobExecutionContext context){
        
    	log.debug("---------------------ResourcesMonthJobLauncherDetails------------------------"); 
